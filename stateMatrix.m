...
sma = AddState(sma, 'Name',str(MatrixState.WaitForReward),...
    'Timer',0,...
    'StateChangeConditions', {TimerEnd(TimerIDFeedbackDelayCorrect),str(MatrixState.WaitForRewardEncoreCue),...
...
sma = AddState(sma, 'Name',str(MatrixState.WaitForRewardEncoreCue),...
    'Timer',max(0, TaskParameters.GUI.FixedEncoreCueSubDur),...
    'StateChangeConditions', {'Tup',str(MatrixState.WaitForRewardEncoreAfterCue),...
                              RewardOut,str(MatrixState.timeOut_SkippedFeedback)},...
    'OutputActions', [WaitFeedbackStim AirFlowRewardOff FeedbackCorrectBNC]);
sma = AddState(sma, 'Name',str(MatrixState.WaitForRewardEncoreAfterCue),...
    'Timer',max(0, TaskParameters.GUI.FeedbackDelayFixedEncore - TaskParameters.GUI.FixedEncoreCueSubDur),...
...
sma = AddState(sma, 'Name',str(MatrixState.WaitForPunish),...
    'Timer',0,...
    'StateChangeConditions', {TimerEnd(TimerIDFeedbackDelayPunish),str(MatrixState.WaitForPunishEncoreCue),...
...
sma = AddState(sma, 'Name',str(MatrixState.PunishGrace),...
    ...
    'OutputActions', WaitFeedbackStim);
sma = AddState(sma, 'Name',str(MatrixState.WaitForPunishEncoreCue),...
    'Timer',max(0, TaskParameters.GUI.FixedEncoreCueSubDur),...
    'StateChangeConditions', {'Tup',str(MatrixState.WaitForPunishEncoreAfterCue),...
                              PunishOut,str(MatrixState.timeOut_SkippedFeedback)},...
    'OutputActions', [WaitFeedbackStim AirFlowRewardOff FeedbackIncorrectBNC]);
sma = AddState(sma, 'Name',str(MatrixState.WaitForPunishEncoreAfterCue),...
    'Timer',max(0, TaskParameters.GUI.FeedbackDelayFixedEncore - TaskParameters.GUI.FixedEncoreCueSubDur),...
