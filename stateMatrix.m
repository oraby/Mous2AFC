...
sma = AddState(sma, 'Name',str(MatrixState.WaitPunishOut),...
    'Timer',TaskParameters.GUI.WaitFinalPokeOutSec,...
    'StateChangeConditions', {'Tup',str(MatrixState.TriggerTimeoutIncorrectChoice), PunishOut, str(MatrixState.TriggerTimeoutIncorrectChoice),...
                              TimerEnd(TimerIDIncorrectTimeout), str(MatrixState.timeOut_IncorrectChoice)},...
    'OutputActions', [iff(~TaskParameters.GUI.CatchError, TimerTrig(TimerIDIncorrectTimeout), {}),...
                      WaitForPokeOutStim]);
sma = AddState(sma, 'Name',str(MatrixState.TriggerTimeoutIncorrectChoice),...
    ...
    'OutputActions', TimerTrig(TimerIDIncorrectTimeout));
...
sma = AddState(sma, 'Name',str(MatrixState.timeOut_IncorrectChoice),...
    'Timer',0,...
    'StateChangeConditions', {sprintf('GlobalCounter%d_End',CounterIDIncorrectTimeout),str(MatrixState.ext_ITI)},...
